...
#    Updated: 2022/06/09 23:33:12 by chduong          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
C3D_SRC		=	main.c		data_collect.c		key_control.c		utils.c\
				${addprefix parsing/,\
					player_position.c	parsing.c		create_map.c\
					check_each_elem.c	check_elems.c	check_map.c}\
				${addprefix trigonometry/,\
					ft_0_to_90.c		ft_90_to_180.c		ft_180_to_270.c\
					ft_270_to_360.c}\
				${addprefix display/,\
